<div class="col-md-12 col-sm-12 col-xs-12 clear-pads" id="problem">
	<div class="container">
		...
		<div class="col-md-6 text-block">
			<?php echo __( 'В комплекс проекта Wood Pellets входит лесозавод, завод древесных гранул и станция когенерация.
			Проект Wood Pellets предлагает произвести независимый комплекс заводов который обеспечивает
			безотходное производство пеллет.', 'preico' ) ?>
		</div>
	</div>
