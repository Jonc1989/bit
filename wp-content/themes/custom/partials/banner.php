			...
			<div class="cycle">
				...
				<div class="titles">
                    ...
                    <div class="top-second">
                        <div class="second-title" style="width: 140px; text-align: center;margin-left: -19px;">
	                        <?php echo __( 'Mайнинг - фермa 4,5 MWT 6750 Th/s', 'preico' ) ?>
                        </div>
                        <div class="third-title" style="width: 190px;text-align: center;margin-right: -39px;">
